...
def forward(
    ...
    if key_padding_mask is None:
        output = flash_attn_func(q, k, v, self.attn_dropout if self.training else 0.0, softmax_scale=None, causal=True).view(
...
def replace_llama_attn_with_flash_attn_dropout():
